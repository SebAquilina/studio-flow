...
const EXEMPT_READERS = new Set<string>([
  ...
  "getPricingTierBySlug",// admin only; public renders listed tiers on /pricing
  "getQuote",           // admin only by id; public uses getQuoteByToken          // admin/leads inbox; public side has /api/contact (writer)
